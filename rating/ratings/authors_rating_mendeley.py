##Fix for mendeley APi
##Hey mr SAM! please read example_json_mendeley.json in this folder...
...
class AuthorsRating:
    ...
    def value(self):
        authors = [{
            ...
            'abrev_name' : "%s %s." % (self.authors_family[i], self.authors_given[i]),
            'abrev_name_2' : "%s, %s." % (self.authors_family[i], self.authors_given[i]),
